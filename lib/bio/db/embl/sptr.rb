#
# bio/db/sptr.rb - SwissProt and TrEMBL protein sequence database 
#                  class
#
...
#
#  $Id: sptr.rb,v 1.1 2001/11/01 22:03:48 nakao Exp $
#
...
* ID Line (Identification)
    Bio::SPTR#idline -> Hash
    Bio::SPTR#idline(key) -> String
...
module Bio
  ...
  class SPTR < EMBLDB
    ...
    attr_reader :ac_regrexp
    attr_reader :entry_regrexp
    ...
    #
    # Bio::SPTR#idline -> Hash
    # Bio::SPTR#idline(key) -> String/Int
    def idline(key=nil)
      unless @data['ID']
	tmp=Hash.new
	a=@orig['ID'].split(/ +/)         
    ...
    #
    TOPICS=['ALTERNATIVE PRODUCTS','CATALYTIC ACTIVITY','CAUTION',
    ...
    DATABASE_IDENTIFIER=['EMBL','CARBBANK','DICTYDB','ECO2DBASE','ECOGENE',
