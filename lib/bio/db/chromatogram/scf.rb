#
# = bio/db/chromatogram/scf.rb - Scf class 
#
...
module Bio
  # == Description
  #
  # This class inherits from the Chromatogram superclass. It captures the information contained
  # within an scf format chromatogram file generated by DNA sequencing. See the Chromatogram class
  # for usage
  class Scf < Chromatogram
    ...
    # see Chromatogram class for how to create an Scf object and its usage
