...
module Bio
  ...
  # within an abi format chromatogram file generated by DNA sequencing. See the Chromatogram class
  # for usage.
  class Abi < Chromatogram
    ...
    # see Chromatogram class for how to create an Abi object and its usage
